...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.errorChannel = make(chan *DoJobArgs)
	mr.waitChannel = make(chan bool)
	mr.countChannel = make(chan bool)
	mr.workerChannel = make(chan string)
